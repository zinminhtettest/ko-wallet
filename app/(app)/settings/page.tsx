...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-5 max-w-2xl">
      ...
      <Link href="/settings/language" className="card p-5 flex items-center gap-4 hover:bg-slate-50">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-slate-500">English / မြန်မာ / ไทย</div>
        </div>
      ...
      <Link href="/investments" className="card p-5 flex items-center gap-4 hover:bg-slate-50">
        <div className="w-11 h-11 rounded-xl bg-brand-50 text-brand-600 grid place-items-center">
          <TrendingUp className="w-5 h-5" />
        </div>
        <div className="flex-1">
          <div className="font-semibold">{t("Investments")}</div>
          <div className="text-sm text-slate-500">Stocks, crypto, gold positions</div>
        </div>
        <div className="text-slate-400">→</div>
      </Link>

      <Link href="/settings/bank-accounts" className="card p-5 flex items-center gap-4 hover:bg-slate-50">
        <div className="w-11 h-11 rounded-xl bg-brand-50 text-brand-600 grid place-items-center">
          <Building2 className="w-5 h-5" />
        </div>
        <div className="flex-1">
          <div className="font-semibold">{t("Bank Accounts")}</div>
          <div className="text-sm text-slate-500">Track balances across banks</div>
        </div>
        <div className="text-slate-400">→</div>
      </Link>
      ...
      <Link href="/settings/currency" className="card p-5 flex items-center gap-4 hover:bg-slate-50">
        <div className="w-11 h-11 rounded-xl bg-brand-50 text-brand-600 grid place-items-center">
          <Globe className="w-5 h-5" />
        </div>
        <div className="flex-1">
          <div className="font-semibold">Currency Rates</div>
          <div className="text-sm text-slate-500">FX rates for Net Worth combined view</div>
        </div>
        <div className="text-slate-400">→</div>
      </Link>

      <Link href="/clients" className="card p-5 flex items-center gap-4 hover:bg-slate-50">
        <div className="w-11 h-11 rounded-xl bg-brand-50 text-brand-600 grid place-items-center">
          <Briefcase className="w-5 h-5" />
        </div>
        <div className="flex-1">
          <div className="font-semibold">Clients & Invoices</div>
          <div className="text-sm text-slate-500">Track outstanding invoices for your business</div>
        </div>
        <div className="text-slate-400">→</div>
      </Link>
